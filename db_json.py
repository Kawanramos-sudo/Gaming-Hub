...
def fetch_all_data():
    ...
    try:
        ...
        SELECT g.id, g.name, g.description, g.genres, g.release_date, g.image, g.images, 
               g.green_man_nome, g.nuuvem_id, g.popularity, 
        ...
        for row in rows:
            game_id, name, description, genres, release_date, image, images, green_man_nome, nuuvem_id, popularity, store_name, price, url = row
